...
class ArchiveHandler:
    ...
    def _extract_compressed(self, file_path: Path, extract_dir: Path,
                           compression_type: str) -> Tuple[Path, List[Path]]:
    ...
    def _create_7z(self, source_dir: Path, output_path: Path,
                   password: Optional[str] = None) -> Path:
    ...
    def _create_tar(self, source_dir: Path, output_path: Path,
