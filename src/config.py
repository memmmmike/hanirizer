...
class Config:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Config':
        ...
        # Load other settings
        for key in ['file_patterns', 'recursive', 'preserve_structure', 
                    'verbose', 'dry_run', 'parallel_workers']:
            if key in data:
...
class VendorConfig:
    ...
    VENDORS = {
        'cisco': {
            'service_accounts': [
                'admin', 'cisco', 'enable', 'operator', 'monitor',
                'rancid', 'netconf', 'restconf'
            ],
            'patterns': {
                'enable_secret': {
        ...
        'paloalto': {
            'service_accounts': [
                'admin', 'panorama', 'api', 'monitor', 'operator'
            ],
            'patterns': {
                'phash': {
        ...
        'juniper': {
            'service_accounts': [
                'root', 'admin', 'operator', 'read-only', 'super-user'
            ],
            'patterns': {
                'encrypted_password': {
